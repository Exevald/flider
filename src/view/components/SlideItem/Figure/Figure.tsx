...
const DrawRectangle = (coordinates: Point, figureArea: Area, color: string) => {
...
const DrawArc = (coordinates: Point, figureArea: Area, color: string) => {
    const canvas = document.getElementById("canvas") as HTMLCanvasElement;
    const canvasContext = canvas.getContext("2d") as CanvasRenderingContext2D;
    canvasContext.fillStyle = color;
...
const DrawTriangle = (coordinates: Point, figureArea: Area, color: string)=> {
    const canvas = document.getElementById("canvas") as HTMLCanvasElement;
    const canvasContext = canvas.getContext("2d") as CanvasRenderingContext2D;
    canvasContext.fillStyle = color;
...
const DrawStar = (coordinates: Point, figureArea: Area, color: string) => {
    const canvas = document.getElementById("canvas") as HTMLCanvasElement;
    const canvasContext = canvas.getContext("2d") as CanvasRenderingContext2D;
    canvasContext.fillStyle = color;
...
const DrawFigure = (shape: ShapeType, coordinates: Point, figureArea: Area, color: string) => {
    switch (shape) {
        case ShapeType.Rectangle:
            return DrawRectangle(coordinates, figureArea, color);
        case ShapeType.Arc:
            return DrawArc(coordinates, figureArea, color);
        case ShapeType.Triangle:
            return DrawTriangle(coordinates, figureArea, color);
        case ShapeType.Star:
            return DrawStar(coordinates, figureArea, color)
    }
}
